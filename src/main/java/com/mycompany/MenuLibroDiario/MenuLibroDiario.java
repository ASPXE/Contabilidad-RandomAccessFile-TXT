...
import com.mycompany.libro_contabilidad.Modelo.LibroMayor;
...
public class MenuLibroDiario extends javax.swing.JFrame {
    ...
    private void btnBuscarTxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarTxtActionPerformed
        ...
        int cuenta = arch.numeroDeCuenta(nums, 510);
        double totalMesEnero = arch.totalMes(fechas, 1, cargosOAbonos);
        double totalMesFebrero = arch.totalMes(fechas, 2, cargosOAbonos);
        double totalMesMarzo = arch.totalMes(fechas, 3, cargosOAbonos);
        double totalMesAbril = arch.totalMes(fechas, 4, cargosOAbonos);
        double totalMesMayo = arch.totalMes(fechas, 5, cargosOAbonos);
        double totalMesJunio = arch.totalMes(fechas, 6, cargosOAbonos);
        double totalMesJulio = arch.totalMes(fechas, 7, cargosOAbonos);
        double totalMesAgosto = arch.totalMes(fechas, 8, cargosOAbonos);
        double totalMesSeptiembre = arch.totalMes(fechas, 9, cargosOAbonos);
        double totalMesOctubre = arch.totalMes(fechas, 10, cargosOAbonos);
        double totalMesNoviembre = arch.totalMes(fechas, 11, cargosOAbonos);
        double totalMesDiciembre = arch.totalMes(fechas, 12, cargosOAbonos);
        ...
        try {
            ...
            arch.agregarLibroMayor(lm, "Prueba", cuenta, totalMesEnero, totalMesFebrero, totalMesMarzo, totalMesAbril, totalMesMayo, totalMesJunio, totalMesJulio, totalMesAgosto, totalMesSeptiembre, totalMesOctubre, totalMesNoviembre, totalMesDiciembre);
